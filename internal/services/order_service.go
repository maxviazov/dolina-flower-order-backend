...
type CreateOrderRequest struct {
	MarkBox    string                   `json:"mark_box" binding:"required"`
...
type CreateOrderItemRequest struct {
	...
	BoxCount   float64 `json:"box_count" binding:"required"`
	PackRate   int     `json:"pack_rate" binding:"required"`
	TotalStems int     `json:"total_stems" binding:"required"`
	FarmName   string  `json:"farm_name" binding:"required"`
	TruckName  string  `json:"truck_name" binding:"required"`
